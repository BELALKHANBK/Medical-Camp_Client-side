...
import '../app.css'; // ✅ custom input style
...
<div className="relative">
  ...
  >
    {showPassword ? <FaRegEyeSlash /> : <FaRegEye />}
              ...
              <button
                type="submit"
                className="mt-4 w-83 bg-blue-600 hover:bg-blue-700 
            ...
            <p className='text-center mt-2'>
              Don’t have an account? <Link to='/register' className='underline text-center'>Register</Link>
            </p>
